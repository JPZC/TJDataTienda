		...
		success: function(respuesta){
			...
			=============================================*/
				...
				$(".editarTalla").html(
					...
					'<input class="form-control input-lg tagsInput detalleTalla" value="'+detalles.Referencia+'" data-role="tagsinput" type="text" style="padding:20px">'
...
function editarMiProducto(imagen){
	...
	var finOferta = $("#modalEditarProducto .finOferta").val();
  	...
  	if(seleccionarTipo == "virtual"){
		...
		var detalles = {"Referencia": $("#modalEditarProducto .detalleTalla").tagsinput('items'),							
